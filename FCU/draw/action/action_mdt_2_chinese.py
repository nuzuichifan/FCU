...
fig.set_figwidth(11)#这个是设置整个图（画布）的大小
...
axes[1,3].set_title("第十七年")
axes[1,3].axis=([100,700,0,1200])
# axes[1,3].xlim(100,700)
# axes[1,3].ylim(0,1200)
...
#plt.savefig("action1_chinese.jpg",dpi=800)
plt.show()